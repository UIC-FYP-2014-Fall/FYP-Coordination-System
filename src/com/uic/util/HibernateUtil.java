...
final public class HibernateUtil {
	...
	//这里提供一个根据id返回对象的方法
		public static Object findById(@SuppressWarnings("rawtypes") Class clazz,java.io.Serializable id){
	...
	//这里提供一个根据id返回对象的方法
	//OpenSessionInView
	public static Object findByIdOpenInView(@SuppressWarnings("rawtypes") Class clazz, java.io.Serializable id){
	...
	//OpenSessionInView
		@SuppressWarnings("rawtypes")
		public static List executeQueryByPageOpenInView(String hql,String [] parameters,int pageSize,int pageNow){
			Session s=getCurrentSession();
			List list=null;
