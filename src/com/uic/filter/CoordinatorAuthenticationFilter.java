...
public class CoordinatorAuthenticationFilter extends HttpServlet implements
		Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		//If the role is not coordinator, the authentication fails, the user login again.
