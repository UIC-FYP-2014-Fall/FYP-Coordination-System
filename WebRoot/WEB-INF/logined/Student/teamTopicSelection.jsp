					...
					<c:if test="${requestScope.memberAreTheSame=='true' }">
						...
						<div class="block">
							<div class="navbar navbar-inner block-header">
								<ul class="breadcrumb">
									...
									<i class="icon-chevron-right show-sidebar"
										...
										rel='tooltip'>&nbsp;</a></i>
									<li><a
										href="${pageContext.request.contextPath }/chooseTopic.do?flag=goChooseTopic">Choose
											Topic</a> <span class="divider">/</span></li>
							...
							<div class="block-content collapse in">
								<div class="span12">
									<form
										action="${pageContext.request.contextPath }/chooseTopic.do?flag=selectGroupTopic"
										method="post"form-horizontal">
										<%
										...
										<div class="form-actions">
											...
											<button onclick="window.location='${pageContext.request.contextPath }/chooseTopic.do?flag=goChooseTopic'" type="reset" class="btn">Cancel</button>
										</div>
									</form>
								</div>
							</div>
