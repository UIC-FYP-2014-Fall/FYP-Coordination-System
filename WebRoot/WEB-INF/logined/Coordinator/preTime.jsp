				...
				<div class="row-fluid">
					...
					<c:if test="${PreTimeOperation=='error'}">
						<div class="alert alert-error ErrorInfo">
							<button type="button" class="close" data-dismiss="alert">&times;</button>
							<h4>Error</h4>
							The operation failed! Presentation start or end time error!
							Please check.
						</div>
					</c:if>
							...
							<div class="span12">
								<c:if test="${PreDateTime=='true' }">
									<div class="alert alert-info">
										<p>
											From: <strong>${PreStartDateTime }</strong>
										</p>
										<p>
											To:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>${PreEndDateTime }</strong>.
										</p>
										<p>
											Click <a href="#edit" onclick="btn()">here</a> to change.
										</p>
									</div>
									<div id="edit" style="display:none;">
										<!-- BEGIN FORM-->
										<form class="form-horizontal" method="post"
											action="${pageContext.request.contextPath }/preTime.do?flag=setPreTime"
											id="form_sample_1">
											<fieldset>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<div class="input-prepend">
															...
															<input type="text" name="startDate" data-required="1"
																class="span10"
																value='<c:if test="${startDate!=null }">${startDate }</c:if>'
																id="dpd1" readonly>
														</div>
														<div id="starttime" class="input-append">
															<input data-format="hh:mm:ss" name="startTime"
																type="text" class="span5" readonly></input> <span
												...
												<div class="control-group">
													...
													<div class="controls">
														<div class="input-prepend">
															<span class="add-on"><i class="icon-calendar"></i></span>
															<input type="text" name="endDate" class="span10"
																value="<c:if test="${endDate!=null }">${endDate }</c:if>"
																id="dpd2" readonly />
														</div>
														<div id="endtime" class="input-append">
															<input data-format="hh:mm:ss" name="endTime" type="text"
																class="span5" readonly></input> <span class="add-on">
								...
								<c:if test="${PreDateTime=='false' }">
									<c:if test="${OpenTime=='true' }">
										<div class="alert alert-error alert-block">
											...
											<p>
												System open time is not completed. Please check <a
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<div class="input-prepend">
															<span class="add-on"><i class="icon-calendar"></i></span>
															<input type="text" name="startDate" data-required="1"
																class="span10" value='' id="dpd1" readonly>
														</div>
														<div id="starttime" class="input-append">
															<input data-format="hh:mm:ss" name="startTime"
																type="text" class="span5" readonly></input> <span
